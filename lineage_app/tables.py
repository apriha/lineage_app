...
class SharedDnaGenesTable(tables.Table):
    ...
    details_col = tables.TemplateColumn(
        template_name="pages/shared_dna_genes_details_link.html",
        orderable=False,
        verbose_name="Details",
    )

    delete_col = tables.TemplateColumn(
        template_name="pages/shared_dna_genes_delete_form.html",
        orderable=False,
        verbose_name="Delete",
    )
...
class DiscordantSnpsTable(tables.Table):
    # https://stackoverflow.com/a/6275332
    download_col = tables.TemplateColumn(
        template_name="pages/discordant_snps_download_link.html",
        orderable=False,
        verbose_name="Download",
    )

    delete_col = tables.TemplateColumn(
        template_name="pages/discordant_snps_delete_form.html",
        orderable=False,
        verbose_name="Delete",
    )
